...
static uint32_t ina219_cal_value;
static uint32_t ina219_current_driver_ma;
static float ina219_power_multiplier_mw;
...
setCalibration_32V_2A(void)
{
  ...
  ina219_current_driver_ma = 1.0; // Current LSB = 100uA per bit (1000/100 = 10)
  ina219_power_multiplier_mw = 20; // Power LSB = 1mW per bit (2/1)

  // Set Calibration register to 'Cal' calculated above
  wireWriteRegister(INA219_REG_CALIBRATION, ina219_cal_value);
...
{
  ina219_i2caddr = 0x43;
  ina219_current_driver_ma = 0;
  ina219_power_multiplier_mw = 0.0f;
}
...
getCurrent_mA(void)
{
  ...
  valueDec /= ina219_current_driver_ma;
  return valueDec;
}
...
getPower_mW(void)
{
  ...
  float valueDec = (int16_t)value;
  valueDec *= ina219_power_multiplier_mw;
  return valueDec;
}

void
wireWriteRegister(uint8_t reg, uint16_t value)
{
 ...
 */
void
wireReadRegister(uint8_t reg, uint16_t *value)
{
